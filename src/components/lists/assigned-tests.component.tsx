      ...
      <Grid container spacing={2}>
        {tests.map((test) => (
          <Grid item key={test._id} xs={12} sm={6} md={4}>
            <Card style={{ textDecoration: 'none', display: 'flex', flexDirection: 'column', height: '100%' }}>
              ...
              <MuiLink component={Link} to={`/test-view/${test._id}`} color="primary" underline="hover" style={{ textAlign: 'right', paddingRight: '16px' }}>
                View Details
              </MuiLink>
            </Card>
          </Grid>
